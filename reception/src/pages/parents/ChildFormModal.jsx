    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      >
        <div className="sticky top-0 bg-surface border-b border-slate-200 p-6 flex items-center justify-between">
          <h2 id={modalTitleId} className="text-2xl font-bold text-slate-900">{modalTitle}</h2>
          <button
            onClick={onClose}
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">
              {t('parentsPage.form.childSchool')} <span className="text-error-500">*</span>
            </label>
            <input
              type="text"
              required
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <label
                  ...
                  className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-700 rounded-lg font-medium hover:bg-slate-200 transition-colors text-sm"
                >
