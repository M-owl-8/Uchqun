...
| CP-004 | Teacher children list (GAP-001) | GET /teacher/children | teacher/Attendance.jsx, teacher/ChildDetail.jsx | schoolId-scoped; `{ success, data: [...] }` shape |
| CP-005 | Attendance marking (GAP-003) | POST /attendance, GET /attendance, PATCH /attendance/:id | teacher/Attendance.jsx | Returns `childSnapshot`; PATCH for corrections |
| CP-006 | Child observations (GAP-002) | POST /teacher/observations, GET /teacher/observations/recent, GET /teacher/children/:id/observations | teacher/QuickObservation.jsx, teacher/DailyReflection.jsx | Private to staff; not visible to parents |
| CP-007 | Teacher reflections (GAP-005) | POST /teacher/reflections, GET /teacher/reflections | teacher/DailyReflection.jsx | Filtered by `teacherId` — cross-teacher invisible |
| CP-008 | Parent journal (GAP-005) | POST /teacher/journal (write), GET /parent/children/:id/journal (read) | teacher/DailyReflection.jsx (write), parent portal (read) | `isVisibleToParent` flag controls visibility |
| CP-009 | Admin doc filter (GAP-006, GAP-018) | GET /admin/documents?status= | admin/DocumentApprovalQueue.jsx | Keep GET /admin/documents/pending unchanged |
| CP-010 | Reception doc filter (GAP-007) | GET /reception/documents?status= | reception portal doc list | Additive query param — non-breaking |
