      ...
      <div className="bg-surface rounded-3xl p-8 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-slate-900">{t('settings.myMessages')}</h2>
          </div>
          <button
            onClick={onClose}
        ...
        {loadingMessages ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-slate-500">{t('settings.noMessages')}</p>
          </div>
        ) : (
          <div className="space-y-4">
            {myMessages.map((msg) => (
              <div key={msg.id} className="border border-slate-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <div className="mb-4">
                  <p className="text-sm font-medium text-slate-700 mb-2">{t('settings.yourMessage')}:</p>
                ...
                {msg.reply && (
                  <div className="border-t border-slate-200 pt-4 mt-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-sm font-medium text-brand-700">{t('settings.governmentReply')}</p>
