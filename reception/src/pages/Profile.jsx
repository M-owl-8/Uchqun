...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">{t('profile.title', { defaultValue: 'Profile' })}</h1>
        <p className="text-slate-500 font-medium mt-1">{t('profile.subtitle', { defaultValue: 'Your account information and messages' })}</p>
      </div>
      ...
      <Card className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-900">{t('profile.profileInfo', { defaultValue: 'Profile Information' })}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100">
            ...
            <div>
              <p className="text-xs text-slate-500 uppercase font-semibold mb-1">{t('profile.email', { defaultValue: 'Email' })}</p>
          ...
          <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100">
            ...
            <div>
              <p className="text-xs text-slate-500 uppercase font-semibold mb-1">{t('profile.phone', { defaultValue: 'Phone' })}</p>
