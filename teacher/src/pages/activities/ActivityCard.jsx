    ...
    >
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {activity.startDate && (
            <div className="flex items-center gap-2 p-3 bg-brand-50 rounded-xl border border-brand-100">
              ...
              <div className="min-w-0">
                <p className="text-xs text-brand-600 font-semibold mb-0.5">{t('activitiesPage.formStartDate') || 'Boshlanish'}</p>
          ...
          {activity.endDate && (
            <div className="flex items-center gap-2 p-3 bg-brand-50 rounded-xl border border-brand-100">
              <Calendar className="w-4 h-4 text-brand-600 flex-shrink-0" />
              <div className="min-w-0">
                <p className="text-xs text-brand-600 font-semibold mb-0.5">{t('activitiesPage.formEndDate') || 'Tugash'}</p>
                <p className="text-sm font-bold text-slate-900 truncate">
        ...
        {activity.teacher && (
          <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs text-slate-500 font-semibold mb-0.5">{t('activitiesPage.teacher') || 'O\'qituvchi'}</p>
        ...
        {activity.services && Array.isArray(activity.services) && activity.services.length > 0 && (
          <div>
            <p className="text-xs font-semibold text-slate-600 mb-2">{t('activitiesPage.formServices') || 'Xizmatlar'}</p>
