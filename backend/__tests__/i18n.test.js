...
const EXPECTED_CODE_COUNT = 275; // +20 R09 retrospective catalogue (CONSOLIDATION II P8). +2 D-41 CHILD_READ_FORBIDDEN, CHILD_READ_FAILED (CONSOLIDATION II P7). +1 D-26 ATTENDANCE_DATE_TOO_EARLY (DEEP HARDENING P8). +1 D-06 DOCUMENT_UPLOAD_STORAGE_FAILED. +1 D-11 RATING_NO_ASSIGNED_TEACHER. +1 D-01 ATTENDANCE_PARTIALLY_SAVED. Prior: 249 = +5 PP-JOURNAL-BULK. 244 = +15 IRR-MONTHLY-MILESTONES. 229 = -11 OBSERVATIONS-REMOVAL. 240 = +4 CROSS-IRR-VISIBILITY.
