...
export const InfoItem = ({ label, value, icon: Icon, color = 'text-brand-500' }) => (
  <div className="group">
    <label className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 block">{label}</label>
    <div className="flex items-center gap-3">
      <div className="p-2.5 rounded-xl bg-slate-50 group-hover:scale-110 transition-transform duration-200">
