...
// Two account families with DIFFERENT passwords. Campaign I conflated them:
// P6 logged into the seed-02 government accounts with PW, got 401, filed D-44
// ("documented credentials do not work"), and overwrote four production
// government passwords on that false basis. credentials.md was right all along.
// Use pwFor(email) — never assume one password covers the estate.
export const PW = 'Uchqun@2026';        // accounts created by seed-beta-demo.mjs (P1)
export const PW_SEED02 = 'Test@2026';   // pre-existing seed-02 accounts, per credentials.md:6
export const pwFor = (email) => (/@uchqun\.uz$|@davlat\.uz$/.test(email) ? PW_SEED02 : PW);
