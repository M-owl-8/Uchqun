    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-p-sepia-50 rounded-lg">
      ...
      <Card className="p-6 bg-p-sepia-50 border-p-sepia-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <Link to="/media" className="text-p-brand-600 hover:text-p-brand-700 font-medium text-sm">
            {t('help.linkMedia')}
          </Link>
          <Link to="/meals" className="text-p-brand-600 hover:text-p-brand-700 font-medium text-sm">
            {t('help.linkMeals')}
          </Link>
          <Link to="/settings" className="text-p-brand-600 hover:text-p-brand-700 font-medium text-sm">
            {t('help.linkSettings')}
          </Link>
        </div>
      </Card>
