...
| 27 | Government | S1 Deep Audit | (this commit) | 2026-05-21 | 14 findings: 1 Critical (GOV-001 Dashboard wrong param for AI warnings count), 4 High (GOV-002 credentials email undefined, GOV-003 schools silently truncated, GOV-004 warnings.* missing all locales, GOV-005 wrong status code for suspended login), 5 Medium, 4 Low; 4 CP gaps (D-1 thru D-4); i18n verdict: NOT READY for Russian users; `audits/government/01-audit.md` |
