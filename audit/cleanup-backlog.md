...
| 04-001 | 04 App | CRITICAL | Nested `ToastProvider` + `NotificationProvider` in component tree (teacher + parent) | not-fixed | closed | main | da1d3b7 | ParentApp.jsx: ToastProvider+I18nextProvider removed; 8 parent files import from shared/context/ToastContext; duplicate Toast files deleted | 2026-05-10 |
...
| 09-002 | 09 Mobile | HIGH | Third ToastContext in teacher bundle; nested ToastProvider in ParentApp | not-fixed | closed | main | da1d3b7 | Same fix as 04-001: parent ToastContext.jsx deleted; all parent components use shared context | 2026-05-10 |
