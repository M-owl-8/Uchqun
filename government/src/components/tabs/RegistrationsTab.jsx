    ...
    <>
      ...
      <Card className="p-6 space-y-4">
        {loadingRegistrations ? (
          <div className="flex items-center justify-center min-h-[120px]"><LoadingSpinner size="sm" /></div>
            ...
            <div className="space-y-3">
              ...
              {approvedCredentials.setPasswordUrl ? (
                ...
                <p className="text-xs text-amber-600">
                  {t('government.setPasswordMissing', { defaultValue: "Set-password havolasi mavjud emas. Admin bilan bog'laning." })}
                </p>
              )}
