  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 animate-in fade-in duration-500">
      ...
      {activities.length > 0 ? (
        ...
        <div className="text-center py-20 bg-surface rounded-[2rem] border-2 border-dashed border-slate-200">
          <FileX className="w-12 h-12 text-slate-200 mx-auto mb-4" />
          <p className="text-slate-400 font-medium text-lg">{t('activitiesPage.empty')}</p>
        </div>
      )}
