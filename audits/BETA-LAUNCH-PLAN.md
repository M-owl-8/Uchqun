...
|---|---|---|---|---|
| **G1** | TP-PARENT-ASSIGNMENT classified + fixed | Resolve the dual-chain parent-child linkage (denormalized vs canonical). Unblocks every phase-2 parent verification. | 1 session (1 day) | ✅ CLOSED 2026-06-07 — `audits/redesign/TP-PARENT-ASSIGNMENT.md`. Classification (d) SEED CORRUPTION; teacherParentScope.js canonical chain + migration 20260607100000 patches Zulfiya's orphaned group. PP-* phase-2 walks unblocked. |
